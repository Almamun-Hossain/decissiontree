(function( $ ) {
    ...
    $.fn.decisionTree.defaults = {
        ...
        cardClass: "dctree-body",
        questionClass: "dctree-question"
    };
    ...
    function renderRecursive(data, elem, id) {
        var container = $('<div></div>')
            ...
            .addClass('card-body');
            // .addClass('col-xs-12');
        var question = $('<div></div>').addClass(settings.questionClass).append('<i class="fas fa-question-circle"></i>'+data.question);
        ...
        if (typeof data.decisions != "undefined") {
            ...
            for(var i=0; data.decisions.length > i; i++) {
                ...
                var genId = guid();
                var grid = $('<div></div>').addClass('col-md-12');
                var answer = $('<div></div>')
        ...
        if (id != 'dctree-first') {
            ...
            controls.append($('<a href="javascrip:;" class="dctree-prev btn"><i class="fas fa-arrow-left"></i> Back</a>'));
